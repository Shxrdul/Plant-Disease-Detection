...
def openphoto():
    dirPath = "C:/Users/Shardul/Desktop/Main/classify"
    fileList = os.listdir(dirPath)
    for fileName in fileList:
        os.remove(dirPath + "/" + fileName)
    fileName = askopenfilename(initialdir='C:/Users/Shardul/Desktop/Main', title='Select image for analysis ',
                               filetypes=[('image files', '.jpg')])
    dst = "C:/Users/Shardul/Desktop/Main/classify"
